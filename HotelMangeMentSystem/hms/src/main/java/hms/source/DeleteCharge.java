...
public class DeleteCharge  implements fileinterface{
    ...
    public void FRead() {
        try {
            FileReader fileRead = new FileReader(new File("C:\\DB\\\\Delete\\deleteCharge.txt"));
    ...
    public void FWrite(String a) throws IOException {
        BufferedWriter log = new BufferedWriter(new FileWriter("C:\\DB\\\\Delete\\deleteCharge.txt", true));
